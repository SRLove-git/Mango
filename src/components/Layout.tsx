      ...
      <footer className="footer glass">
        ...
        {(() => {
          ...
          const items: { key: string; url: string; label: string; icon: string }[] = [
            ...
            { key: 'rss', url: socialLinks.rss, label: 'RSS', icon: 'rss' },
          ].filter(i => i.url);
          if (items.length > 0) {
            return (
      ...
      <div id="header-waves" aria-hidden="true">
        ...
        >
          ...
          <g className="parallax">
            <use xlinkHref="#gentle-wave" x="48" y="0" fill="var(--bg)" />
            <use xlinkHref="#gentle-wave" x="48" y="3" fill="var(--bg)" opacity="0.7" />
            <use xlinkHref="#gentle-wave" x="48" y="5" fill="var(--bg)" opacity="0.5" />
            <use xlinkHref="#gentle-wave" x="48" y="7" fill="var(--bg)" opacity="0.3" />
          </g>
        </svg>
      </div>
      {isHomePage ? (
